 ...
 *
 * These are agent-agnostic — every Copilot HTTP call needs them. Per-agent
 * extensions (e.g. Anthropic's `anthropic-version` / `anthropic-beta`) live
 * inside that agent's plugin, layered on top of this base.
 */
